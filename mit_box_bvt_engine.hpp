...
class mit_box_bvt_engine : public mit_bvt_engine {
  public:
    ...
    virtual  void generate_and_apply_sltu_boxes(uint8_t conditional_type, uint64_t lo1, uint64_t up1, uint64_t lo2, uint64_t up2);
    ...
    virtual  void generate_and_apply_diseq_boxes(uint8_t conditional_type, uint64_t lo1, uint64_t up1, uint64_t lo2, uint64_t up2);
