...
EFLAGS := -w -g -O3 -m64 -std=c++11 -I../boolector/src/ -I../boolector/deps/cadical/src/ -L../boolector/build/lib/ -L../boolector/deps/cadical/build/ -L../boolector/deps/btor2tools/build/
